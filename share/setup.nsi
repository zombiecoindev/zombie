...
!define URL http://www.zombiecoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/zombiecoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\zombiecoin-qt.exe
...
OutFile zombiecoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/zombiecoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/zombiecoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\zombiecoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\zombiecoin-qt.exe
